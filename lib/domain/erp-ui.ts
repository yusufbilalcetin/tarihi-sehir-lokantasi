...
export const ERP_UI_CONFIG: Readonly<Record<ErpWorkspaceModule, ErpUiConfig>> = {
  ...
  attendance: { title:"Puantaj",description:"Giriş, çıkış, mola, süre ve gerekçeli yönetici düzeltmeleri.",question:"Bugün kim çalışıyor?",empty:"Seçili aralıkta puantaj kaydı yok.",columns:[{key:"staff",label:"Personel"},{key:"business_date",label:"İş Günü",kind:"date"},{key:"clock_in_at",label:"Giriş",kind:"datetime"},{key:"clock_out_at",label:"Çıkış",kind:"datetime"},{key:"duration_minutes",label:"Süre",kind:"duration"},{key:"status",label:"Durum",kind:"status"},{key:"correction_reason",label:"Düzeltme Gerekçesi"}]},
  schedules: { title:"Haftalık Vardiya",description:"7 günlük personel vardiya görünümü; çakışmalar kayıtta engellenir.",question:"Bu hafta kim, ne zaman çalışacak?",empty:"Seçili haftada vardiya planı yok.",columns:[{key:"staff",label:"Personel"},{key:"starts_at",label:"Başlangıç",kind:"datetime"},{key:"ends_at",label:"Bitiş",kind:"datetime"},{key:"role_label",label:"Görev"},{key:"location_label",label:"Konum"},{key:"status",label:"Durum",kind:"status"},{key:"notes",label:"Not"}]},
  payroll: { title:"Operasyonel Bordro",description:"Yasal bordro motorundan bağımsız operasyonel ödeme kaydı.",question:"Bu dönemde operasyonel olarak ne ödenecek?",empty:"Operasyonel bordro kaydı yok.",columns:[{key:"staff",label:"Personel"},{key:"period_start",label:"Dönem Başlangıç",kind:"date"},{key:"period_end",label:"Dönem Sonu",kind:"date"},{key:"worked_minutes",label:"Çalışma",kind:"duration"},{key:"overtime_minutes",label:"Fazla Mesai",kind:"duration"},{key:"gross_salary",label:"Brüt",kind:"money"},{key:"allowances",label:"Ekler",kind:"money"},{key:"deductions",label:"Kesinti",kind:"money"},{key:"net_payable",label:"Net",kind:"money"},{key:"status",label:"Durum",kind:"status"}]},
